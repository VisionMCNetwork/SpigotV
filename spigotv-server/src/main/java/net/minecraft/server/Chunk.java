...
public class Chunk {
    ...
    private void a(int i, int j, int k, int l) {
        if (l > k && this.world.areChunksLoaded(new BlockPosition(i, 0, j), 16)) {
            for (int i1 = k; i1 < l; ++i1) {
                this.world.updateBrightness(EnumSkyBlock.SKY, new BlockPosition(i, i1, j), this);
            }
    ...
    public final int getLightSubtracted(BlockPosition blockposition, int i) { return this.a(blockposition, i); }
