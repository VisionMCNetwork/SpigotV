...
public class EntityPotion extends EntityProjectile {
    ...
    protected float m() {
        return SpigotV.INSTANCE.getConfig().getPotionGravity();
    }

    protected float j() {
        return SpigotV.INSTANCE.getConfig().getPotionMultiplier();
    }

    protected float l() {
        return SpigotV.INSTANCE.getConfig().getPotionVerticalOffset();
    }
