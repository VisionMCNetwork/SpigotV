...
import rip.visionmc.spigotv.util.OptimizedRemoveUtil;
...
public abstract class World implements IBlockAccess {
    ...
    private int I; private int getSkylightSubtracted() { return this.I; }
    ...
    */
    ...
    public final int getLight(BlockPosition blockposition, boolean checkNeighbors) { return this.c(blockposition, checkNeighbors); }
    ...
    public void entityJoinedWorld(Entity entity, boolean flag) {
        ...
        // Spigot start
        if (SpigotV.INSTANCE.getConfig().isEntityActivation() && !org.spigotmc.ActivationRange.checkIfActive(entity)) {
            entity.ticksLived++;
            entity.inactiveTick();
